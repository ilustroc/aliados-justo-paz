<div id="modalEditConciliacion" class="hidden" data-modal>
    ...
    <div class="jp-modal-panel max-w-lg p-0 overflow-hidden rounded-3xl">
        <div class="p-8">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold text-[#2B2B2B]">Editar conciliación</h2>
            ...
            <form id="formEditConciliacion" method="POST" action="" class="space-y-5">
                @csrf
                @method('PUT')
                
                <div>
                    <label class="mb-1.5 block text-xs font-bold uppercase tracking-wide text-slate-500">Aliado</label>
                    <input type="text" id="edit_aliado_nombre" class="jp-input !py-3 bg-slate-50 border-slate-200 text-slate-500 cursor-not-allowed" disabled>
                </div>

                <div>
                    <label class="mb-1.5 block text-xs font-bold uppercase tracking-wide text-slate-500">Código</label>
                    <input type="text" id="edit_codigo" class="jp-input !py-3 bg-slate-50 border-slate-200 text-slate-500 cursor-not-allowed" disabled>
                </div>

                <div>
                    <label class="mb-1.5 block text-xs font-bold uppercase tracking-wide text-slate-500">Nombre del caso *</label>
                    <input type="text" name="nombre_caso" id="edit_nombre_caso" class="jp-input !py-3 border-slate-200" required>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="fecha_registro" id="edit_fecha_registro" class="jp-input !py-3 border-slate-200" required>
                    </div>
                </div>
